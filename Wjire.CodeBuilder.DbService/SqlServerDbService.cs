...
namespace Wjire.CodeBuilder.DbService
{
    ...
    /// SqlServerDbService
    /// </summary>
    public class SqlServerDbService : BaseDbService, IDbService
    {

        public SqlServerDbService(ConnectionInfo info) : base(info)
        {
        ...
        {
            return $"Data Source={ConnectionInfo.IP};Initial Catalog={ConnectionInfo.DbName};User ID={ConnectionInfo.User};PassWord={ConnectionInfo.Pwd};";
        }
